...
<h3 class="page-title">Functions</h3>
<blockquote>
<p>A function is a block of code that is defined once but can be used multiple times</p>
</blockquote>
<pre><code class="lang-js">//function declaration
function greet(){
...
console.log(sums);
//answer: 14
//how: B I D M A S: 3 x 4 + 2 - see numbers</code></pre>
<hr />
</div>
</template>
