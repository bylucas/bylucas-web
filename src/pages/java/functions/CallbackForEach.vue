...
<h3 class="page-title">Callback and forEach</h3>
<blockquote>
<p>Functions taking functions as arguments are called 'callback functions'. ForEach is a method that expects a callback function</p>
</blockquote>
