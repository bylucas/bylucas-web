...
<h3 class="page-title">Object Literals</h3>
<blockquote>
<p>Objects are variables, that can contain many values. The values are written as name:value pairs (<em>name and value separated by a colon</em>).</p>
<p>You define (<em>and create</em>) a JavaScript object with an object literal</p>
<p>The name:values pairs in JavaScript objects are called properties</p>
<p>Objects can also have methods. Methods are actions that can be performed on objects. Methods are stored in properties as function definitions.</p>
